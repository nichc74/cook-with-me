...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$600000$Mb9yhYh9QlJO9klTVf08K1$BsX6VMmxSPYNPaZfMzDUXpEbZS1EGExgEDv+O1Q7Vk0=','2023-10-01 04:36:40.739616',1,'leviathan','','','',1,1,'2023-08-21 08:31:00.315946');
...
INSERT INTO `cookbook_category` VALUES (6,'Entree'),(27,'Side'),(29,'Side Dish'),(30,'Desserts'),(59,'Sandwich');
...
CREATE TABLE `cookbook_instruction` (
  ...
  `recipe_component_id` bigint NOT NULL,
  `image_id` bigint DEFAULT NULL,
  `recipe_instructional_component_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cookbook_instruction_recipe_component_id_c718f78b_fk_cookbook_` (`recipe_component_id`),
  ...
  CONSTRAINT `cookbook_instruction_recipe_component_id_c718f78b_fk_cookbook_` FOREIGN KEY (`recipe_component_id`) REFERENCES `cookbook_recipecomponent` (`id`),
...
INSERT INTO `cookbook_instruction` VALUES (88,'Cut beef into strips that are ~ 5mm thick, 1cm wide and about 5cm long (1/5\\\" x 2/5\\\" x 2\\\"). If using shortribs, trim excess fat, cut the meat off the bone. Then cut each piece in half lengthwise (to form 2 \\\"steaks\\\") then slice into 5mm thick. (See step photos in post or video at 0.11s, Note 6)',1,109,114,1),(89,'Marinate – Put beef in a bowl. Add marinade ingredients, then mix. Set aside marinate while you proceed with recipe, ~15 – 20 minutes is all it needs. (Note 5)',2,109,NULL,1),(90,'Sauce – Mix the Sauce ingredients in a very large mixing bowl.',1,110,115,2),(91,'Noodles – Cook sweet potato noodles per packet directions (normally 8 min in boiling water). Drain, briefly rinse under tap water then shake off excess water well. Add noodles into the bowl with the dressing. DO NOT MIX.',2,110,NULL,2),(92,'Batch 1 – Heat 2 tablespoons of oil in a large non-stick pan (30cm/12\\\") over high heat. Cook the brown onion, white part of green onion and shiitake mushrooms with 1/2 tsp salt for 2 1/2 to 3 minutes, stirring constantly, just until starting to soften but not going golden. Pour on top of the noodles – don\'t mix yet!',1,111,116,3),(93,'Batch 2 – Using the same pan still on high heat, heat 1 tbsp oil then cook the carrot and capsicum for 1 1/2 minutes, constantly stirring. Add spinach, green onion and the final 1/2 tsp salt. Keep cooking for 1 1/2 minutes until the spinach is wilted. Transfer into the noodle bowl – still don\'t mix!',2,111,NULL,3),(94,'Cook beef – In the same pan, heat the final 1 tbsp of oil still on high heat. Add beef and cook for 1 1/2 minutes until very lightly golden and just cooked through. Add to the noodle bowl. Don\'t mix!',3,111,NULL,3),(95,'Mix! Add most of the sesame seeds (reserve some for topping). NOW you can mix! Toss, toss, toss.',4,111,NULL,3),(96,'Serve – Transfer into a serving bowl, sprinkle with remaining sesame seeds. This is meant to be eaten warm, not piping hot. Eat!',5,111,NULL,3),(104,'Toss the zucchini in oil then sprinkle with salt and toss to (roughly) coat all over.',1,165,157,NULL),(105,'Cook – Heat a large non-stick pan over medium-high heat. Place half the zucchini cut side down and cook for 3 to 4 minutes until the surface is golden. Turn and cook the skin side for 3 minutes. Pile onto a serving plate and repeat with remaining zucchini.',2,165,NULL,NULL),(106,'Sauce – cool the pan slightly then return to medium heat. Heat the oil then sauté the garlic until light golden. Add remaining Sauce ingredients, simmer for 30 seconds until syrupy.\n',3,165,158,NULL),(107,'Serve – Pour over zucchini, pile on Crispy Asian Shallots and green onion. Eat!',4,165,159,NULL),(108,'Noodles – Cook the noodles in a large saucepan per packet directions. Scoop out ~1/2 cup cooking water. Strain noodles and set aside.',1,168,161,NULL),(109,'Sauce – Melt butter in the same saucepan over medium heat. Add garlic and cook, stirring until soft. Add oyster sauce, fish sauce, Maggi seasoning and 1/4 cup cooking water. Stir to combine.',2,168,162,NULL),(110,'Toss – Add cooked noodles, parmesan and green onion. Toss until the noodles are all coated, and the sauce is not pooled in the bottom of the saucepan. Add more cooking water 1 tbsp at the time, if needed to loosen the noodles.',3,168,NULL,NULL),(111,'Serve immediately!',4,168,163,NULL),(112,'Serving suggestion: fried egg and broccolini cooked with the noodles*, tossed with Asian Sesame Dressing you always have in your fridge.\n* Broccolini takes about 3 minutes, so put it into the water before/after/with the noodles depending on the noodle cooking time.',5,168,NULL,NULL),(113,'Cutting – Trim the base of the bok choy then separate all the leaves. Leave the delicate baby bok choy in the centre intact, it\'s precious! Cut giant stems in half lengthwise so they are all roughly the same size. Rinse in colander, shake off excess water (don\'t need to dry fully).',1,171,NULL,NULL),(114,'Sauce – Stir Sauce ingredients except water in a jug until cornflour is dissolved. (Easier to make lump free with less liquid). Then stir in water.',2,171,NULL,NULL),(115,'Gingery oil – Put the ginger and oil in a large non-stick pan. Turn onto medium heat. Once the ginger starts sizzling, sauté for 1 minute until it turns light golden and is a bit floppy. Add bok choy then use 2 spatulas to toss the ginger for around 15 seconds to coat.',3,171,NULL,NULL),(116,'Steam – Turn heat up to medium, pour water over. Cover with lid and steam for just 45 seconds.',4,171,NULL,NULL),(117,'Sauce – Remove lid (bok choy will still be a bit underdone), pour in sauce, toss for 30 seconds until sauce changes from murky to clear, and thickens. Bok choy should be just floppy but still soft crunch, not mushy. If your sauce gets too thick (Note 4), add a tiny splash of water and mix.',5,171,NULL,NULL),(118,'Serve – Pour the bok choy and all the sauce onto a serving plate, then eat!\n',6,171,NULL,NULL),(119,'Preheat oven to 180C/350F (160C fan). Spray a 20cm/8\" square tin with oil and line with baking/parchment paper with overhang (so it can be lifted out once cooked).',1,174,NULL,NULL),(120,'Base – Place Shortbread Base ingredients in a food processor fitted with the standard \"S\" blade. Pulse 5 to 10 times until it becomes like sand. (Or use tips of fingers, Note 2). Pour into the tin, spread, then press firmly into the base, pushing it right up to the edges. Using something flat to press in is helpful!',2,174,NULL,NULL),(121,'Bake base for 20 minutes or until golden on the edges and pale golden in the middle. Remove from oven. (⚠️ Note: don\'t let it cool, pour in curd immediately).',3,174,NULL,NULL),(122,'Lemon Curd – While the base is baking, place Lemon Topping ingredients in a bowl and whisk until combined.',4,174,NULL,NULL),(123,'Bake 20 minutes – Pour Lemon Curd onto base, then bake for 20 minutes until the topping is set but still soft.',5,174,NULL,NULL),(124,'Cool – Remove from then oven and cool on the counter for 1 hour, then fridge for at least 2 hours. Slice into 16 squares. Dust with icing sugar (confectionary sugar) and serve!',6,174,NULL,NULL),(140,'Garlic Aioli: Mix mayonnaise and garlic together. Set aside for 30 minutes+ for the flavour to develop (do not keep for more than 3 days tops).',1,198,NULL,NULL),(141,'Caramelised Onion: Melt butter in a skillet over medium low heat. Add onions and stir to coat in butter. Place lid on (or place a baking tray over skillet) and leave for 20 minutes, stirring once or twice. Remove lid then cook for a further 20 minutes, stirring every now and then, until onion is golden (increase heat slightly if the colour is not changing). Add sugar, vinegar, salt and pepper. Cook for a further 10 minutes until jammy. Remove from heat and keep warm.',2,198,NULL,NULL),(142,'Take beef out of fridge 20 minutes before cooking. Season generously with salt and pepper.',1,199,NULL,NULL),(143,'Heat oil in a skillet over high heat (or heat BBQ). Cook steak to your liking - if using a secondary cut like Bavette, skirt or flat iron, it\'s best medium rare.',2,199,NULL,NULL),(144,'Transfer beef to a plate, cover loosely with foil and rest for 5 - 10 minutes. Then slice thinly against the grain.',3,199,NULL,NULL),(145,'Cut turkish bread into 15cm/6\" lengths and split into half. Toast lightly.\n',1,200,NULL,NULL),(146,'Spread the bottom piece generously with garlic aioli. Top with rocket, then tomato slices, beef, caramelised onion. Spread the top piece of bread with mustard then place on top.\n',2,200,NULL,NULL),(182,'Mix together mustard, garlic and onion powder. Then mix in remaining ingredients.\n',1,221,NULL,NULL),(183,'Place beef in a ziplock bag with Marinade and marinade overnight (12 - 24 hours).\n',2,221,NULL,NULL),(184,'Remove from the fridge 30 minutes before cooking to bring to room temperature - key for even cooking of steaks. Shake off excess marinade.\n',3,221,NULL,NULL),(185,'Brush BBQ Grills with oil, then heat on high heat until is really hot - you should see wisps of smoke. Or heat a heavy based skillet on high until very hot, then add oil - it will heat almost instantly.\n',4,221,NULL,NULL),(186,'Add steaks. For 2cm / 3/4\" thick steaks, cook the first side for 2 minutes, then turn and cook the other side for 2 minutes (medium rare 52°C/125°F, chart below for other doneness temps). (Note 3)\n',5,221,NULL,NULL),(187,'Remove from skillet onto a WARM plate, cover loosely with foil and set aside for 5 minutes.\n',6,221,NULL,NULL),(188,'Serve! I couldn\'t resist garlic butter - see recipe in notes.\n',7,221,NULL,NULL),(189,'Guanciale – Cut into 0.5cm / 1/5\" thick slices then into batons.',1,223,NULL,NULL),(190,'Carbonara sauce – Place eggs and yolks in a large bowl. Whisk to combine. Then stir in the parmesan and pepper.',2,223,NULL,NULL),(191,'Cook pasta – Bring 4 litres (4 quarts) of water to the boil with the salt. Add pasta and cook per the packet directions.\n',3,223,NULL,NULL),(192,'Reserve pasta water – Just before draining, scoop out 1 cup of pasta cooking water, then drain the pasta.\n',4,223,NULL,NULL),(193,'Pasta in pan – Tip the hot pasta into the pan and toss to coat in guanciale fat.',5,223,NULL,NULL),(194,'Mix pasta in sauce – Transfer the pasta and any residual fat in the pan into the bowl with the egg. Add 1/2 cup (125 ml) pasta cooking water. Stir vigorously using the handle of a wooden spoon for 1 minute and watch as the sauce transforms from watery to creamy and clings to the pasta strands!',6,223,NULL,NULL),(195,'Serve – Transfer into warm bowls. Serve immediately, garnished with a little extra parmigiana reggiano if desired, and a pinch of black pepper and finely chopped parsley.',7,223,NULL,NULL);
...
INSERT INTO `cookbook_metric` VALUES (1,'cup(s)'),(2,'tsp'),(3,'tbsp'),(4,'gram(s)');
...
INSERT INTO `cookbook_recipe` VALUES (66,'Japchae – Korean noodles','JNagi',20,15,5,'Korean','/japchae_korean_noodles',6,113,'https://www.recipetineats.com/japchae-korean-noodles/','Unpublished'),(105,'Spicy Asian Zucchini','Nagi',5,10,5,'Asian','/spicy_asian_zucchini',27,156,'https://www.recipetineats.com/spicy-asian-zucchini-recipe/','Unpublished'),(106,'Garlic Noodles','Nagi',6,6,1,'Asian Esque','/garlic_noodles',29,160,'https://www.recipetineats.com/garlic-noodles/','Unpublished'),(107,'Bok Choy in Ginger Sauce','Nagi',3,3,4,'Asian','/bok_choy_in_ginger_sauce',29,164,'https://www.recipetineats.com/bok-choy-in-ginger-sauce/','Unpublished'),(108,'Easy Lemon Bars','Nagi',15,40,16,'Western','/easy_lemon_bars',30,165,'https://www.recipetineats.com/lemon-bars/','Unpublished'),(139,'Steak Sandwich','Nagi',10,60,4,'Western','/steak_sandwich',59,196,'https://www.recipetineats.com/steak-sandwich/','Unpublished'),(145,'Beef Steak Marinade','Nagi',5,5,2,'Western','/beef_steak_marinade',6,202,'https://www.recipetineats.com/beef-steak-marinade/','Unpublished'),(146,'Carbonara','Nagi',5,15,4,'Italian','/carbonara',6,203,'https://www.recipetineats.com/carbonara/','Unpublished');
/*!40000 ALTER TABLE `cookbook_recipe` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cookbook_recipecomponent`
--

DROP TABLE IF EXISTS `cookbook_recipecomponent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cookbook_recipecomponent` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `component_name` varchar(128) NOT NULL,
  `recipe_id` bigint NOT NULL,
  `type` varchar(128) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `cookbook_recipecompo_recipe_id_0e745e2a_fk_cookbook_` (`recipe_id`),
  CONSTRAINT `cookbook_recipecompo_recipe_id_0e745e2a_fk_cookbook_` FOREIGN KEY (`recipe_id`) REFERENCES `cookbook_recipe` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=224 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cookbook_recipecomponent`
--

LOCK TABLES `cookbook_recipecomponent` WRITE;
/*!40000 ALTER TABLE `cookbook_recipecomponent` DISABLE KEYS */;
INSERT INTO `cookbook_recipecomponent` VALUES (106,'BEEF AND MARINADE',66,'ingredient'),(107,'NOODLE DRESSING',66,'ingredient'),(108,'NOODLES & VEGETABLES',66,'ingredient'),(109,'QUICK BEEF MARINADE',66,'instruction'),(110,'SAUCE AND NOODLES',66,'instruction'),(111,'VEGETABLES',66,'instruction'),(163,'General',105,'ingredient'),(164,'SPICY SAUCE',105,'ingredient'),(165,'General Zucchini',105,'instruction'),(166,'Noodles',106,'ingredient'),(167,'General Garlic Sauce',106,'ingredient'),(168,'General Garlic Noods',106,'instruction'),(169,'General Bok Choy',107,'ingredient'),(170,'Sauce',107,'ingredient'),(171,'General Bok Choy',107,'instruction'),(172,'Shortbread base',108,'ingredient'),(173,'Lemon curd topping',108,'ingredient'),(174,'General Lemon Bars',108,'instruction'),(195,'General Steak Sandwich',139,'ingredient'),(196,'CARAMELISED ONION',139,'ingredient'),(197,'STEAK SANDWICH',139,'ingredient'),(198,'General Steak Sandwich',139,'instruction'),(199,'BEEF',139,'instruction'),(200,'ASSEMBLE SANDWICH',139,'instruction'),(219,'General Beef Steak',145,'ingredient'),(220,'MARINADE',145,'ingredient'),(221,'General Steak Sandwich',145,'instruction'),(222,'General Carbonara',146,'ingredient'),(223,'General Carbonara',146,'instruction');
/*!40000 ALTER TABLE `cookbook_recipecomponent` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cookbook_recipeingredient` (
  ...
  `metric_back_up` varchar(64) NOT NULL,
  `recipe_component_id` bigint NOT NULL,
  ...
  KEY `cookbook_recipeingre_recipe_component_id_5faef77f_fk_cookbook_` (`recipe_component_id`),
  ...
  CONSTRAINT `cookbook_recipeingre_recipe_component_id_5faef77f_fk_cookbook_` FOREIGN KEY (`recipe_component_id`) REFERENCES `cookbook_recipecomponent` (`id`),
...
INSERT INTO `cookbook_recipeingredient` VALUES (209,20,2,'tsp',106,1),(210,6,2,'tsp',106,1),(211,21,2,'tsp',106,1),(212,8,0.5,'tsp',106,1),(213,5,0.25,'cup',107,2),(214,6,2,'tsp',107,2),(215,7,0.5,'tsp',107,2),(216,9,1.5,'tsp',107,2),(217,10,0.5,'tsp',107,2),(218,8,1,'tsp',107,2),(219,11,250,'grams',108,3),(220,12,4,'tbsp',108,3),(221,10,1,'tsp',108,3),(222,13,1,'',108,3),(223,14,3,'',108,3),(224,22,200,'grams',108,3),(225,16,2,'',108,3),(226,17,1,'',108,3),(227,18,4.5,'cups',108,3),(228,19,2,'tbsp',108,3),(242,46,5,'',163,4),(243,47,1,'tbsp',163,4),(244,10,0.75,'0',163,4),(245,48,0.25,'0',163,4),(246,49,1,'',163,4),(247,47,1,'0',164,5),(248,50,3,'',164,5),(249,51,1,'0',164,5),(250,9,1,'0',164,5),(251,52,1,'0',164,5),(252,53,2,'tbsp',164,5),(253,54,140,'grams',166,6),(254,55,30,'grams',167,NULL),(255,56,6,'',169,NULL),(256,57,3,'tsp',170,NULL),(257,58,0.75,'cup',172,NULL),(258,59,0.25,'cup',172,NULL),(259,60,0.5,'cup',172,NULL),(260,61,0.5,'0',172,NULL),(262,63,3,'large',173,NULL),(263,64,1,'cup',173,NULL),(264,65,2,'tbsp',173,NULL),(265,66,1,'tbsp',173,NULL),(266,67,0.5,'cup',173,NULL),(314,92,0.75,'cup',195,NULL),(315,7,1,'large',195,NULL),(316,95,3,'',196,NULL),(317,96,3,'tbsp',196,NULL),(318,97,2,'tbsp',196,NULL),(319,98,1,'0',196,NULL),(320,99,0.25,'tbsp',196,NULL),(321,100,700,'grams',197,NULL),(322,99,NULL,'',197,NULL),(324,102,2,'',197,NULL),(325,103,60,'grams',197,NULL),(326,104,NULL,'',197,NULL),(327,105,NULL,'',197,NULL),(350,106,2,'',219,NULL),(351,107,1,'tsp',220,NULL),(352,7,0.5,'tsp',220,NULL),(353,108,0.5,'tsp',220,NULL),(354,52,1,'tbsp',220,NULL),(355,109,1,'tbsp',220,NULL),(356,110,1,'tbsp',220,NULL),(357,111,1,'tbsp',220,NULL),(358,8,NULL,'',220,NULL),(359,112,175,'grams',222,NULL),(360,63,2,'large',222,NULL),(361,113,2,'egg',222,NULL),(362,114,100,'grams',222,NULL),(363,8,0.25,'tbsp',222,NULL),(364,115,400,'grams',222,NULL),(365,116,1,'tbsp',222,NULL),(366,117,1,'',222,NULL);
...
INSERT INTO `cookbook_recipeingredientcomponent` VALUES (1,'BEEF AND MARINADE',66),(2,'NOODLE DRESSING',66),(3,'NOODLES & VEGETABLES',66),(4,'General',105),(5,'SPICY SAUCE',105),(6,'Noodles',106),(7,'Sauce',106),(8,'',107),(9,'Sauce',107),(10,'Shortbread base',108),(11,'Lemon curd topping',108),(12,'',139),(13,'CARAMELISED ONION',139),(14,'STEAK SANDWICH',139),(15,'',145),(16,'MARINADE',145),(17,'',146);
...
INSERT INTO `cookbook_recipeinstructionalcomponent` VALUES (1,'QUICK BEEF MARINADE',66),(2,'SAUCE AND NOODLES',66),(3,'VEGETABLES',66),(4,'',105),(5,'',106),(6,'',107),(7,'',108),(8,'',139),(9,'BEEF',139),(10,'ASSEMBLE SANDWICH',139),(11,'',145),(12,'',146);
...
-- Dump completed on 2023-10-01  4:53:04
