...
--
-- Table structure for table `cookbook_cuisine`
--

DROP TABLE IF EXISTS `cookbook_cuisine`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cookbook_cuisine` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cookbook_cuisine`
--

LOCK TABLES `cookbook_cuisine` WRITE;
/*!40000 ALTER TABLE `cookbook_cuisine` DISABLE KEYS */;
INSERT INTO `cookbook_cuisine` VALUES (1,'Korean'),(2,'Asian'),(3,'Asian Esque'),(4,'Western'),(5,'Italian');
/*!40000 ALTER TABLE `cookbook_cuisine` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cookbook_recipe` (
  ...
  `serves` int NOT NULL,
  `cuisine_backup` varchar(128) NOT NULL,
  ...
  KEY `cookbook_recipe_cuisine_id_a82a5878_fk_cookbook_cuisine_id` (`cuisine_id`),
  ...
  CONSTRAINT `cookbook_recipe_cuisine_id_a82a5878_fk_cookbook_cuisine_id` FOREIGN KEY (`cuisine_id`) REFERENCES `cookbook_cuisine` (`id`),
...
INSERT INTO `cookbook_recipe` VALUES (66,'Japchae – Korean noodles','JNagi',20,15,5,'Korean','/japchae_korean_noodles',6,113,'https://www.recipetineats.com/japchae-korean-noodles/','published',0,1),(105,'Spicy Asian Zucchini','Nagi',5,10,5,'Asian','/spicy_asian_zucchini',27,156,'https://www.recipetineats.com/spicy-asian-zucchini-recipe/','published',0,2),(106,'Garlic Noodles','Nagi',6,6,1,'Asian Esque','/garlic_noodles',27,160,'https://www.recipetineats.com/garlic-noodles/','published',0,2),(107,'Bok Choy in Ginger Sauce','Nagi',3,3,4,'Asian','/bok_choy_in_ginger_sauce',27,164,'https://www.recipetineats.com/bok-choy-in-ginger-sauce/','Unpublished',0,2),(108,'Easy Lemon Bars','Nagi',15,40,16,'Western','/easy_lemon_bars',30,165,'https://www.recipetineats.com/lemon-bars/','Unpublished',0,4),(139,'Steak Sandwich','Nagi',10,60,4,'Western','/steak_sandwich',59,196,'https://www.recipetineats.com/steak-sandwich/','Unpublished',0,4),(145,'Beef Steak Marinade','Nagi',5,5,2,'Western','/beef_steak_marinade',6,202,'https://www.recipetineats.com/beef-steak-marinade/','Unpublished',0,NULL),(146,'Carbonara','Nagi',5,15,4,'Italian','/carbonara',6,203,'https://www.recipetineats.com/carbonara/','Unpublished',0,5),(181,'Ultra Crunchy Fried Chicken Burger','Nagi',15,15,4,'Western','/ultra_crunchy_fried_chicken_burger',73,219,'https://www.recipetineats.com/crispy-fried-chicken-burger/','published',0,4);
...
-- Dump completed on 2023-10-05  2:02:08
